...
<html lang="en">
  ...
  <div class="page-wrap">
    ...
    <section class="titulo">		
        ...
        <FORM ACTION="bibliotecaAll.php" method="POST" >
        ...
        <?php
          ...
          if (isset($_POST['buscar1'])){
            header('Location: bibliotecaAd.php');
          } 
          echo '<table border="0" align="center" width="90%">
            ...
            $i=5*($pagina-1)+1;
            $cadena="SELECT id,nombre, numeroP, epub, pdf, biblioteca, copiadora, autor_nombre, categoria, resumen,portada FROM libro WHERE periodo='".$periodo."' and anio!=".$anio." or periodo!='".$periodo."' and anio=".$anio." or periodo!='".$periodo."' and anio!=".$anio;
            ...
            $consulta ="SELECT id,nombre, numeroP, epub, pdf, biblioteca, copiadora, autor_nombre, categoria, resumen,portada FROM libro WHERE periodo='".$periodo."' and anio!=".$anio." or periodo!='".$periodo."' and anio=".$anio." or periodo!='".$periodo."' and anio!=".$anio." LIMIT ".$empezar_desde.",".$cantidad_resultados_por_pagina;
            ...
            while($row=mysqli_fetch_array($resultado)){  
                  ...
                  echo "<a href=bibliotecaAd.php?resumen=".$resumen."&pagina=".$pagina.">reseña</a></td>";
                  ...
                  if($row['epub']!="NULL"){     
                    ...
                    //echo '<a href="\DocUpload\epub\Dona Barbara - Romulo Gallegos.epub" target=_blank><input type="submit"/></a>';
                  }
                  //
                  else echo "<td width=6%></td>";
                  if($row['pdf']!="NULL"){
                    //echo '<td  align="center" VALIGN="top" width=6%><input type="submit" name="'.$row['id'].'" value="PDF" id="pdf"/></td>';  
            ...
            while($row=mysqli_fetch_array($resultado)){
              $a=$row['id'];
              if(isset($_POST['epub'])){
                $cadena="SELECT pdf FROM libro where id=".$a;
                $resultado=mysqli_query($conexion,$cadena)or die( mysql_error());  
                $datos=mysqli_fetch_assoc($resultado);
                $ruta="DocUpload/pdf/".$datos['pdf'];
              }                
            }
            //Fin
            ...
            if($pagina<=$total_paginas){
              ...
              header('Location: bibliotecaAd.php?pagina='.$total_paginas);
            }                                         
          echo   '</thead>  </table>';
            ...
            <div id="redactar-botones">
              <input type="submit" name="buscar1" value="Libros actuales" id="buscar1" class="guardar"/>
            </div>
            </FORM>
    </section>
	</div>
