...
<html lang="en">
  ...
  <div class="page-wrap">
        ...
        <FORM ACTION="bibliotecaAd.php" method="POST" >
		
		<div class="unacolumna">
        <?php   
        if (isset($_POST['buscar'])){
            header('Location: bibliotecaAll.php');
          }       
          ...
          $anio=$row['anio'];
            ...
            echo '<table border="0" align="center" width="90%">
              ...
              $total_paginas = ceil($total_registros / $cantidad_resultados_por_pagina);  
                ...
                //  echo "<tr><td>Autor: <b>".$row['autor_nombre']."</td>";
                 // echo "<td>Etiqueta: <b>".$row['categoria']."</td></tr>";
                 // $resumen=str_replace(' ','*',$row['resumen']);
                 // echo "<tr><td><a href=Biblioteca.php?resumen=".$resumen.">reseña</a></td>";
